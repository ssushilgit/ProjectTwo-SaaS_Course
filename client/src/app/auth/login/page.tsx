                ...
                <div className="bg-white shadow-md rounded-md p-6">
                    ...
                    <form onSubmit={handleLoginSubmission} className="space-y-6" method="POST">
                        <div>
                            ...
                            <div className="mt-1">
                                <input onChange={handleLoginDataChange} name="email" type="email" required className="px-2 py-3 mt-1 block w-full rounded-md border border-gray-300 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-sky-500 sm:text-sm text-gray-900" />
                            </div>
                        </div>
                        <div>
                            <label htmlFor="password" className="block text-sm font-medium text-gray-700">Password</label>
                            <div className="mt-1">
                                <input onChange={handleLoginDataChange} name="password" type="password" autoComplete="email-address" required className="px-2 py-3 mt-1 block w-full rounded-md border border-gray-300 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-sky-500 sm:text-sm text-gray-900" />
                            </div>
                        </div>
                        <div>
